...
class Admin extends CI_Controller
{
	...
	public function pengampu(){
		if ($this->input->post('manajemen') !== NULL) {
			...
			$this->cekLogin();
			$data['data'] = $this->Admin_models->query("SELECT *, (SELECT nama FROM tbl_matakuliah WHERE id = id_mk) as matakuliah, (SELECT nama FROM tbl_dosen WHERE id = id_dosen) as dosen FROM tbl_pengampu");
