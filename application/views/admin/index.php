  ...
  <?php $this->load->view('admin/header'); ?>
              ...
              <div class="card h-100 bg-biru">
                <div class="card-body">
                  <div class="row align-items-center">
										<div class="col-auto">
											<i class="fa-solid fa-user-tie fa-2x text-light"></i>
                    </div>
										<div class="col-auto">
									...
									<div class="row">
										<div class="col-6">
											<button class="btn bg-biru" onclick="setModalTambah();">
												...
												<span class="text text-light">Tambah Data</span>
											</button>
										</div>
										<div class="col-6">
							...
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									<div class="modal-header">
										<h5 class="modal-title" id="myModalLabel">Form Tambah User</h5>
      ...
      <script type="text/javascript">
        ...
        function setModalTambah(){
            ...
            $('#tambahModal').modal();
            $('#myModalLabel').html("Form Tambah User");
